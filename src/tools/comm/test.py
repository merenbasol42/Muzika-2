...
from .service_pkg import ClientWType, ServerWType, ServiceWType
from .std_ifs.srv import Add

class ExampleServer:
    def __init__(self):
        self.srv = ServerWType(Add, self.srv_cb, "ex_server")
...
class ExampleClient:
    def __init__(self):
        self.client = ClientWType(Add, name="ex_cli")
...
class ExampleService:
    def __init__(self):
        self.service = ServiceWType(Add, "Adding Service 1")
